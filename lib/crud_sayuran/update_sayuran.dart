...
class UpdateSayuran extends StatefulWidget {
  final List ?list;
  final int ?index;

  UpdateSayuran({this.list,this.index});

  @override
  State<UpdateSayuran> createState() => _UpdateSayuranState();
}

class _UpdateSayuranState extends State<UpdateSayuran> {
  ...
  void updateData(){
    var url= Uri.parse("http://192.168.254.107/food_fullstack/api_food/updateSayuran.php") ;
    http.post(url,body: {

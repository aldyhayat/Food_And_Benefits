...
class DetailDagingUser extends StatefulWidget {
  List list;
  int index;
  DetailDagingUser({required this.list,required this.index});

  @override
  State<DetailDagingUser> createState() => _DetailDagingUserState();
}

class _DetailDagingUserState extends State<DetailDagingUser> {
  @override

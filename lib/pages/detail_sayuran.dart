...
class DetailSayuranUser extends StatefulWidget {
   List list;
  int index;
  DetailSayuranUser({required this.list,required this.index});

  @override
  State<DetailSayuranUser> createState() => _DetailSayuranUserState();
}

class _DetailSayuranUserState extends State<DetailSayuranUser> {
  @override

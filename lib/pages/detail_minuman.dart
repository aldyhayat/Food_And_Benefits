...
class DetailMinumanUser extends StatefulWidget {
 List list;
  int index;
  DetailMinumanUser({required this.list,required this.index});

  @override
  State<DetailMinumanUser> createState() => _DetailMinumanUserState();
}

class _DetailMinumanUserState extends State<DetailMinumanUser> {
  @override

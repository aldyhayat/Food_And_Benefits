...
class AddMinumanAdmin extends StatefulWidget {
  const AddMinumanAdmin({ Key? key }) : super(key: key);

  @override
  State<AddMinumanAdmin> createState() => _AddMinumanAdminState();
}

class _AddMinumanAdminState extends State<AddMinumanAdmin> {
  File ? _image;
...
Future addData(imageFile) async{
   ...
   var url =Uri.parse("http://192.168.254.107/food_fullstack/api_food/addDataMinuman.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: new AppBar(
        title: new Text("Add Data Minuman"),

...
class UpdateMinumanAdmin extends StatefulWidget {
  final List ?list;
  final int ?index;

  UpdateMinumanAdmin({this.list,this.index});

  @override
  State<UpdateMinumanAdmin> createState() => _UpdateMinumanAdminState();
}

class _UpdateMinumanAdminState extends State<UpdateMinumanAdmin> {
  ...
  void updateData(){
    var url= Uri.parse("http://192.168.254.107/food_fullstack/api_food/update_minuman.php") ;
    http.post(url,body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: new Text("Update DATA Minuman"),

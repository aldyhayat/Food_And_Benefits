...
class DetailAdmin extends StatefulWidget {
  List list;
  int index;
  DetailAdmin({required this.list,required this.index});
...
class _DetailAdminState extends State<DetailAdmin> {
  void deleteData(){
    var url=Uri.parse("http://192.168.254.107/food_fullstack/api_food/delete.php");
    http.post(url, body: {
        ...
        new RaisedButton(
          ...
          onPressed: ()=> {
            ...
            Navigator.of(context).push(
              ...
              (BuildContext context)=> new ListAdmin())
            );
            })
            },
          ),
                      ...
                      children: [
                        RaisedButton(
                            onPressed: ()=>Navigator.of(context).push(
                              new MaterialPageRoute(builder: (BuildContext context) => UpdateData(list: widget.list, index: widget.index,))
                            ),

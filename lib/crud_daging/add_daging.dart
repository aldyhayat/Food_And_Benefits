...
class AddDagingAdmin extends StatefulWidget {
  const AddDagingAdmin({ Key? key }) : super(key: key);

  @override
  State<AddDagingAdmin> createState() => _AddDagingAdminState();
}

class _AddDagingAdminState extends State<AddDagingAdmin> {
...
Future addData(imageFile) async{
   ...
   var url =Uri.parse("http://192.168.254.107/food_fullstack/api_food/addDataDaging.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     appBar: new AppBar(
        title: new Text("Add Data Daging"),
